    ...
    <section className="relative mx-auto max-w-5xl px-6 py-24">
      ...
      <div className="mt-14 grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-6">
        {INTEGRATIONS.map(({ name, icon: Icon }) => (
          <div
            key={name}
            className="flex flex-col items-center gap-3 rounded-2xl border border-white/[0.08] bg-[#111315] px-4 py-6 text-center shadow-inset-hairline transition-colors duration-300 hover:border-emerald-glow/30"
          >
